              ...
              a2.default.extendAliases({
                datetime: {
                  ...
                  onKeyDown: function(e3, t3, i3, a3) {
                    e3.ctrlKey && e3.keyCode === n.default.RIGHT && (this.inputmask._valueSet(M(/* @__PURE__ */ new Date(), a3)), p(this).trigger("setvalue"));
                  },
...
%o`, message, error2, detail);
  ...
  var data_controller_default = class extends Controller {
    connect() {
    }
    getId(e) {
  ...
  __publicField(data_controller_default, "targets", ["personalid"]);

  // app/javascript/controllers/editmodal_controller.js
  var editmodal_controller_default = class extends Controller {
    hideModal() {
  ...
  __publicField(editmodal_controller_default, "targets", ["modal"]);

  // app/javascript/controllers/turbomodal_controller.js
  var turbomodal_controller_default = class extends Controller {
    hideModal() {
      this.element.parentElement.removeAttribute("src");
      this.modalTarget.remove();
    }
    submitEnd(e) {
      if (e.detail.success) {
        Turbo.visit("/retrieve_employments", { frame: "modal" });
      }
    }
  };
  __publicField(turbomodal_controller_default, "targets", ["modal"]);

  // app/javascript/controllers/validation_controller.js
  var import_inputmask = __toESM(require_inputmask());
  var validation_controller_default = class extends Controller {
    connect() {
    }
    emailVerification() {
  ...
  __publicField(validation_controller_default, "targets", ["email", "phone"]);

  // app/javascript/controllers/index.js
  application.register("data", data_controller_default);
  application.register("editmodal", editmodal_controller_default);
  application.register("turbomodal", turbomodal_controller_default);
  application.register("validation", validation_controller_default);
})();
